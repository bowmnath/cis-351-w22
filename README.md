...
|  8   | Unconditional branch (jump)<br>[jump](slides/arch-jump.pdf)<br><br>Assembly programming constructs<br>[conditionals (if statements)](slides/assembly-conditionals.pdf)<br>[loops](slides/assembly-loops.pdf)<br><br>Branch microarchitecture<br>[Implementing branches](slides/arch-impl-beq.pdf)<br><br>Memory load/store<br>[memory instructions](slides/arch-memory.pdf)<br>[Implementing load and store](slides/arch-lw-full-impl.pdf) | [In-class Activities](activities/week-08-microarchitecture.md)<br><br>[Memory handout](./misc/assembly-and-memory.pdf) | |
|  9   | **Spring Break** | | |
