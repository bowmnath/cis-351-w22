...
|  3   | Ripple-Carry Timing<br>[ripple-carry timing slides](slides/ripple-carry-timing.pdf)<br>Multiplexors<br>[multiplexor slides](slides/muxes.pdf)<br>Carry-select adder<br>[carry-select slides part 1](slides/carry-select-part1.pdf)<br>[carry-select slides part 2](slides/carry-select-part2.pdf)<br>Carry-lookahead adder<br>[carry-lookahead slides part 1](slides/carry-lookahead-part1.pdf)<br>[carry-lookahead slides part 2](slides/carry-lookahead-part2.pdf) | [In-class Activities](activities/week-03-faster-adders.md)<br>[Practice Exam 1](practice-exams/practice-exam-1.pdf) | [HW1](https://www.prairielearn.org/pl/course_instance/128993/assessment/2316595) -- Wednesday, Jan. 26 (recommended)<br>[First breadboard lab](https://www.prairielearn.org/pl/course_instance/128993/assessment/2316730) -- Tuesday, Jan. 25 (recommended) |
|  4   | Karnaugh Maps<br>[k-map slides](slides/karnaugh-maps.pdf)<br>Latches<br>[latches slides](slides/latches.pdf) | | **First Midterm** -- Wednesday, February 2 |
