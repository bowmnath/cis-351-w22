...
|  3   | Ripple-Carry Timing<br>[ripple-carry timing slides](slides/ripple-carry-timing.pdf)<br>Multiplexors<br>[multiplexor slides](slides/muxes.pdf)<br>Carry-select adder<br>[carry-select slides part 1](slides/carry-select-part1.pdf)<br>[carry-select slides part 2](slides/carry-select-part2.pdf)<br>Carry-lookahead adder<br>[carry-lookahead slides part 1](slides/carry-lookahead-part1.pdf)<br>[carry-lookahead slides part 2](slides/carry-lookahead-part2.pdf) | | [HW1](https://www.prairielearn.org/pl/course_instance/128993/assessment/2316595) -- Wednesday, Jan. 26 (recommended)<br>[First breadboard lab](https://www.prairielearn.org/pl/course_instance/128993/assessment/2316730) -- Tuesday, Jan. 25 (recommended) |
