...
|  8   | Unconditional branch (jump)<br>[jump](slides/arch-jump.pdf)<br><br>Assembly programming constructs<br>[conditionals (if statements)](slides/assembly-conditionals.pdf)<br>[loops](slides/assembly-loops.pdf)<br><br>Branch microarchitecture<br>[Implementing branches](slides/arch-impl-beq.pdf)<br><br>Memory load/store<br>[memory instructions](slides/arch-memory.pdf)<br>[Implementing load and store](slides/arch-lw-full-impl.pdf) | [In-class Activities](activities/week-08-microarchitecture.md)<br><br>[Memory handout](./handouts/assembly-and-memory.pdf) | |
|  9   | **Spring Break** | | |
|  10  | Control logic<br>[Control logic](slides/arch-control-logic.pdf)<br><br>Arrays<br>[arrays](slides/assembly-arrays-intro.pdf)<br>[arrays and loops](slides/assembly-arrays-loops.pdf)<br><br>Functions<br>[functions](slides/assembly-functions.pdf) | [Practice Exam 3](practice-exams/practice-exam-3.pdf)<br><br>[Practice Exam 3 solutions](practice-exams/practice-exam-3-solutions.pdf)<br><br>[In-class Activities](activities/week-10-load-store.md) | [Branches lab](https://www.prairielearn.org/pl/course_instance/128993/assessment/2317728) -- Tuesday, March 15 (recommended)<br><br>[HW4: Architecture and Microarchitecture](https://www.prairielearn.org/pl/course_instance/128993/assessment/2317659) -- Wednesday, March 16 (recommended)<br><br>[Project 3](https://www.prairielearn.org/pl/course_instance/128993/assessment/2317645) -- Friday, March 18 (standard credit) |
|  11  | Stack<br>[stack](slides/assembly-stack.pdf)<br>[recursion](slides/assembly-recursion.pdf) | [In-class Activities](activities/week-11-arrays-stack.md) | **Third Midterm** -- Monday, March 21<br><br>[Computer instruction types lab](https://www.prairielearn.org/pl/course_instance/128993/assessment/2317909) -- Tuesday, March 22 (recommended) |
|  12  | Memory<br>[memory map](slides/arch-map-memory.pdf)<br>[loading and executing](slides/arch-loading.pdf)<br><br>Programming with memory<br>[data segment code](code-examples/data-segment-final.asm)<br>[heap code](code-examples/malloc.asm)<br>[generic debugging code](code-examples/generic-debug.asm)<br>[stack vs heap vs global (optional -- no video)](code-examples/stack-heap-global.asm)<br><br>Cache motivation<br>[cache motivation](slides/cache-motivation.pdf)<br><br>Direct-mapped cache<br>[direct-mapped cache](slides/cache-direct-map.pdf) | [In-class activities](activities/week-12-recursion-cache.md)<br><br>[Practice Exam 4](practice-exams/practice-exam-4.pdf)<br>[Solutions](practice-exams/practice-exam-4-solutions.pdf) | [Loops lab](https://www.prairielearn.org/pl/course_instance/128993/assessment/2318081) -- Tuesday, March 29 (recommended)<br><br>[HW5: Stack and Microarchitecture](https://www.prairielearn.org/pl/course_instance/128993/assessment/2318101) -- Friday, April 1 (recommended) |
|  13  | Cache conflicts<br>[cache conflicts](slides/cache-direct-conflict.pdf)<br><br>Associative cache<br>[associative cache mapping](slides/cache-associative-map.pdf)<br>[associative cache conflicts (LRU)](slides/cache-associative-conflict.pdf)<br><br>Varying block size in cache<br>[mapping with larger block sizes](slides/cache-block-map.pdf)<br>[blocks of addresses](slides/cache-block-addresses.pdf)<br>[associativity vs block size and address bits](slides/cache-type-comparison.pdf) | [In-class activities](activities/week-13-other-cache.md)<br><br>[Direct-mapped cache handout](handouts/direct-cache-handout.pdf)<br><br>[Set-associative cache handout](handouts/associative-cache-handout.pdf) | **Fourth Midterm** -- Monday, April 4<br><br>[Recursion lab](https://www.prairielearn.org/pl/course_instance/128993/assessment/2318186) -- Tuesday, April 5 (recommended) |
|  14  | Cache performance<br>[cache performance](slides/cache-performance.pdf)<br><br>Basic pipelining in MIPS<br>[pipeline intro](slides/micro-pipeline-intro.pdf)<br>[pipeline performance](slides/micro-pipeline-performance.pdf) | [In-class activities](activities/week-14-block-cache.md)<br><br>[Larger-blocksize cache handout](handouts/block-cache-handout.pdf) | [Cache lab 1](https://www.prairielearn.org/pl/course_instance/128993/assessment/2318299) -- Tuesday, April 12 (recommended)<br><br>[HW6: Cache](https://www.prairielearn.org/pl/course_instance/128993/assessment/2318325) -- Friday, April 15 (recommended) |
|  15  | Data and Control Hazards<br>[data hazards](slides/pipeline-hazards-data.pdf)<br>[control hazards](slides/pipeline-hazards-control.pdf) | [In-class activities](activities/week-15-pipeline.md) | [Project 4](https://www.prairielearn.org/pl/course_instance/128993/assessment/2318185) -- Friday, April 22 (standard credit)<br><br>[Pipeline lab](https://www.prairielearn.org/pl/course_instance/128993/assessment/2318475) -- Friday, April 22 (recommended) |
|  16  | **Final Exam** | | |
