...
|  9   | **Spring Break** | | |
|  10  | Control logic<br>[Control logic](slides/arch-control-logic.pdf)<br><br>Arrays<br>[arrays](slides/assembly-arrays-intro.pdf)<br>[arrays and loops](slides/assembly-arrays-loops.pdf)<br><br>Functions<br>[functions](slides/assembly-functions.pdf) | | [HW4: Architecture and Microarchitecture](https://www.prairielearn.org/pl/course_instance/128993/assessment/2317659) -- Wednesday, March 16 (recommended)<br><br>[Project 3](https://www.prairielearn.org/pl/course_instance/128993/assessment/2317645) -- Friday, March 18 (standard credit) |
